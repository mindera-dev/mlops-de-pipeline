...
def main():
    ...
    shcommand = '/java/datatransfer.sh mart all ' + odate
    res = exec_commands('loadmart', '779792627677.dkr.ecr.us-west-2.amazonaws.com/minderadatatransfer:V1.0.2', shcommand, core_v1)
    print(res)
    ...
    f = open(directory + '/load_mart.txt','w')
    f.write(str(res))
    f.close()
    '''
