...
def main():
    ...
    shcommand = '/java/datatransfer.sh lims ' + odate
    res = exec_commands('loadlims', '779792627677.dkr.ecr.us-west-2.amazonaws.com/minderadatatransfer:V1.0.2', shcommand, core_v1)
    print(res)
